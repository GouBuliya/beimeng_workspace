...
1. 将准备好的内容发送给AI（如ChatGPT、Claude等）
2. AI会生成5个优化后的新标题
3. 确保每个标题都独特且符合平台规则
...
1. **关键词前置**：将高频搜索词放在标题开头
2. **长度适中**：建议50-80字符，不宜过长
3. **避免违禁词**：药品、急救、医疗等词汇
4. **符合平台规则**：
   - 不夸大宣传
   - 不使用特殊符号过多
   - 符合Temu/亚马逊标题规范
5. **保持差异化**：5个标题要有所不同，避免完全雷同

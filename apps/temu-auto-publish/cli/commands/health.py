...
def _display_health_result(result, single_component: bool = False):
    ...
    if single_component:
        ...
        console.print(f"[{status_color}]{status_icon} 总体状态: {status.upper()}[/{status_color}]\n")
...
def _display_component_result(result):
    ...
    console.print(f"[bold]状态:[/bold] [{status_color}]{status_icon} {status.upper()}[/{status_color}]")

...
|----------|-----------------|-----------|------------------|---------|----------------------|------------|
|          | 卫生间收纳柜      | A026      | 规格一：3层       | 5       | ["A026.jpg"]         | https://oss.example.com/A026-3.jpg |
|          | 卫生间收纳柜      | A026      | 规格二：4层       | 5       | ["A026.jpg"]         | https://oss.example.com/A026-4.jpg |
|          | 卫生间收纳柜      | A026      | 规格三：5层       | 5       | ["A026.jpg"]         | https://oss.example.com/A026-5.jpg |
...
- 添加采集数量列（默认5）
- 添加主品负责人列（可手动填写）
- 可选列 `实拍图数组` 配合 `尺寸图链接` 提供尺寸图外链；`尺寸图链接` 需填写完整 URL，不再支持脚本自动拼接。

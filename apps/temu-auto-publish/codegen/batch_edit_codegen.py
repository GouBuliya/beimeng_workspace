...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("tooltip", name="本地上传 网络上传").locator("div").nth(1).set_input_files(
        "A045_A046.mp4"
    )
    page.get_by_text("网络上传").click()
    page.get_by_role("textbox", name="输入视频URL地址,必须以“.文件格式后缀”结尾,建议上传").click()
    ...
    page.get_by_role("button", name="关闭此对话框").click()
    page.locator(
        ".is-fixed-left.is-selection-column.pro-virtual-table__row-cell > .jx-checkbox > .jx-checkbox__input > .jx-checkbox__inner"
    ).first.click()
    page.locator(
        ".vue-recycle-scroller__item-view.hover > .pro-virtual-scroll__row > .pro-virtual-table__row-body > .is-fixed-left.is-selection-column > .jx-checkbox > .jx-checkbox__input > .jx-checkbox__inner"
    ).click()
    page.locator(
        ".vue-recycle-scroller__item-view.hover > .pro-virtual-scroll__row > .pro-virtual-table__row-body > .is-fixed-left.is-selection-column > .jx-checkbox"
    ).click()
    page.locator(
        ".vue-recycle-scroller__item-view.hover > .pro-virtual-scroll__row > .pro-virtual-table__row-body > .is-fixed-left.is-selection-column > .jx-checkbox > .jx-checkbox__input > .jx-checkbox__inner"
    ).click()

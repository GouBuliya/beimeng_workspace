    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            steps = [
                ...
                ("7.10", "尺寸", lambda: batch_controller.step_10_dimensions(product_name=product_name)),
                ...
                ("7.14", "建议售价", lambda: batch_controller.step_14_suggested_price(product_name=product_name)),
                ...
                ("7.18", "产品说明书", lambda: batch_controller.step_18_manual(manual_file_path=manual_pdf_path)),
            ]
            ...
            for step_result in results["steps"]:
                ...
                logger.info(f"  {status_emoji} {step_result['step']} {step_result['name']}: {step_result['status']}")

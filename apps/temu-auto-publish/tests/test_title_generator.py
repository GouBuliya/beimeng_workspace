...
class TestTitleGeneratorModelSuffix:
    ...
    def test_generate_with_model_suffix_basic(self):
        ...
        titles = generator.generate_with_model_suffix(
            ["药箱收纳盒", "厨房收纳架"], model_prefix="A", start_number=1
        )
    ...
    def test_generate_with_model_suffix_custom_prefix(self):
        ...
        titles = generator.generate_with_model_suffix(
            ["测试产品"], model_prefix="B", start_number=100
        )
    ...
    def test_generate_with_model_suffix_with_modifiers(self):
        ...
        titles = generator.generate_with_model_suffix(
            ["测试产品"], model_prefix="A", start_number=1, add_modifiers=True
        )

        assert "A0001型号" in titles[0]
        # 应该包含修饰词
        has_modifier = any(mod in titles[0] for mod in TitleGenerator.OPTIONAL_MODIFIERS)
        assert has_modifier
    ...
    def test_generate_with_model_suffix_multiple_products(self):
        ...
        titles = generator.generate_with_model_suffix(original, model_prefix="A", start_number=10)
    ...
    def test_generate_with_model_suffix_numbering(self):
        ...
        titles = generator.generate_with_model_suffix(["产品"], model_prefix="A", start_number=9999)
...
class TestTitleGeneratorEdgeCases:
    ...
    def test_empty_original_titles(self):
        ...
        titles = generator.generate_with_model_suffix([], model_prefix="A", start_number=1)
    ...
    def test_single_original_title(self):
        ...
        titles = generator.generate_with_model_suffix(
            ["唯一产品"], model_prefix="A", start_number=1
        )
    ...
    def test_unicode_in_titles(self):
        ...
        titles = generator.generate_with_model_suffix(
            ["测试产品 ™"], model_prefix="A", start_number=1
        )

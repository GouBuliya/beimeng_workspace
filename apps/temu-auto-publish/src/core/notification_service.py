...
class NotificationService:
    ...
    async def _send_to_channel(self, channel: NotificationChannel, message: NotificationMessage) -> bool:
        """发送通知到指定渠道.
...
def configure_notifications(config: Dict[str, Any]):
    ...
    if email_config.get("enabled"):
        required_fields = ["smtp_host", "smtp_port", "username", "password", "from_addr", "to_addrs"]

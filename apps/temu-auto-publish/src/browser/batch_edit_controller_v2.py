...
class BatchEditController:
    ...
    async def step_09_weight(
        self, weight: Optional[int] = None, product_name: Optional[str] = None
    ) -> bool:
        """步骤7.9：重量（5000-9999G）.
    ...
    async def step_14_suggested_price(
        self, cost_price: Optional[float] = None, product_name: Optional[str] = None
    ) -> bool:
        """步骤7.14：建议售价（成本价×10）.
        ...
        steps = [
            ...
            (
                ...
                self.step_10_dimensions(
                    length=length, width=width, height=height, product_name=product_name
                ),
            ),
            ...
            (
                "7.14",
                "建议售价",
                self.step_14_suggested_price(cost_price=cost_price, product_name=product_name),
            ),
